...
% A description of the PCB element choices is given in the Figures below.

% \begin{figure}[H]
%     \centering
%     \captionsetup{justification=centering, margin=1cm}
%     \includegraphics[width=0.85\textwidth]{img/pcb-elements.PNG}
%     \caption{PCB Element Choices (Top Layer)}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \captionsetup{justification=centering, margin=1cm}
%     \includegraphics[width=0.85\textwidth]{img/pcb-elements2.PNG}
%     \caption{PCB Element Choices (Bottom Layer)}
% \end{figure}
