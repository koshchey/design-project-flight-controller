...
\textbf{Scope:} Integration of flight controller, power subsystem, communication modules, and mechanical frame with defined signal/power interfaces and timing dependencies. Interfaces are version-controlled and validated per subsystem test logs.
